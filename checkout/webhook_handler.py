...
class StripeWH_Handler:
    ...
    def _send_confirmation_email(self, order):
        ...
        # underscore to mean it only gets used by this class
    ...
    def handle_payment_intent_succeeded(self, event):
        ...
        if username != 'AnonymousUser':
            ...
            if save_info:
                # if the box is checked to save info
        ...
        if order_exists:
            ...
            # if it exists, send a confirmation email
            return HttpResponse(
            ...
            try:
                ...
                return HttpResponse(
                    ...
                    status=500)
        self._send_confirmation_email(order)
        # now we created the order, send confirmation email
        return HttpResponse(
